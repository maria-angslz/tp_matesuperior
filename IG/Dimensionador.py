...
class Ui_Dimensionador(object):
    def setupUi(self, Dimensionador):
        ...
        self.widget.setGeometry(QtCore.QRect(150, 30, 381, 91))
        self.widget.setObjectName("widget")
        self.gridLayout = QtWidgets.QGridLayout(self.widget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.NumeroFilasB_2 = QtWidgets.QSpinBox(self.widget)
        self.NumeroFilasB_2.setObjectName("NumeroFilasB_2")
        self.gridLayout.addWidget(self.NumeroFilasB_2, 1, 2, 1, 1)
        self.NumeroColumnasA = QtWidgets.QSpinBox(self.widget)
        self.NumeroColumnasA.setObjectName("NumeroColumnasA")
        self.gridLayout.addWidget(self.NumeroColumnasA, 2, 0, 1, 1)
        self.NumeroFilasX = QtWidgets.QSpinBox(self.widget)
        ...
        self.NumeroFilasA = QtWidgets.QSpinBox(self.widget)
